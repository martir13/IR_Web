        ...
        $('.megamenu_tabs').each(function(index, value) { 
            ...
            menuTabsNav.click(function() {
                ...
                var menuTabsLinkCurrent = menuTabs.find("a.current").attr("href").substring(1),
                    ...
                    if (menuTabsLinkID === 'section13')
                    {
                        $("#tabGraph").html('<h3>Fall 2013</h3><iframe src="http://public.tableausoftware.com/views/FALL2013_Dashboard/Dashboard?:embed=y&:display_count=no" width="100%" height="900px" frameborder="0" scrolling="no"></iframe>');
                    }
