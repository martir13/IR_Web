...
function loadMethodology(pdfURL) {
  switch(pdfURL)
    {
    case 'http://irweb.erau.edu/Testing/SurveyReporting/GSS/PDF/GSS_DB_SP2012.pdf':
    ...
    case '2012':
      $("#archivesIframe").html('<iframe frameborder="0" src="http://docs.google.com/gview?url=http://irweb.erau.edu/irstudies/GSS/PDF/GSS_DB_SP2012.pdf&amp;embedded=true" style="width:100%; height:392px;"></iframe>');
      break;
...
function loadDataTables(year) {
  switch(year)
    {
    case '2010':
      $("#archivesIframe").html('<iframe frameborder="0" src="http://docs.google.com/gview?url=http://irweb.erau.edu/irstudies/GSS/PDF/methods.pdf&amp;embedded=true" style="width:100%; height:392px;"></iframe>');
      document.getElementById('archivesIframe').contentDocument.location.reload(true);
      break;
    case '2011':
      $("#archivesIframe").html('<iframe frameborder="0" src="http://docs.google.com/gview?url=http://irweb.erau.edu/irstudies/GSS/PDF/methods.pdf&amp;embedded=true" style="width:100%; height:392px;"></iframe>');
...
function loadInstrument(year) {
  switch(year)
    {
    case '2010':
      $("#archivesIframe").html('<iframe frameborder="0" src="http://docs.google.com/gview?url=http://irweb.erau.edu/irstudies/GSS/PDF/Infographic.pdf&amp;embedded=true" style="width:100%; height:392px;"></iframe>');
      document.getElementById('archivesIframe').contentDocument.location.reload(true);
      break;
    case '2011':
      $("#archivesIframe").html('<iframe frameborder="0" src="http://docs.google.com/gview?url=http://irweb.erau.edu/irstudies/GSS/PDF/Infographic.pdf&amp;embedded=true" style="width:100%; height:392px;"></iframe>');
