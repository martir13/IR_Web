    ...
    function updateGraphs(currentGraphs) {
      ...
      switch(currentGraph)
        ...
        //Cases for Acad Exp. ----------------------------------
        case 'degProg':
          loadTwoGraphsNew('degProg', 'GSS_AcadExper/Overall', 'GSS_AcadExper/Overall2');
          break;
        case 'progAdvising':
          loadTwoGraphsNew('progAdvising', 'GSS_AcadExper/Advise', 'GSS_AcadExper/Advisor');
          break;
        case 'enrollLength':
          loadTwoGraphsNew('enrollLength', 'GSS_AcadExper/FourYears', 'GSS_AcadExper/FourYearsWhy');
          break;
...
function setIframeSource(selectID) {
     ...
     $("#graph").html('<iframe id="major_param" src="http://public.tableausoftware.com/views/' + graphID + '_Dashboard?' + filterForGraphs + '&:toolbar=top" width="100%" height="2500px" frameborder="0" scrolling="no"></iframe>');
}