...
//Function to make widgets on homepage bigger when submenu is clicked.
  ...
  $("a#dataInfoLink").click(function (event) {
    ...
    //Add html.
    $("li#dataInfographicWidget").html('<div class="handle">Data Infographic</div><iframe src="http://docs.google.com/gview?url=/Factbook/Alumni/Placement_Rates/PDF/AllMajorAssoc.pdf&embedded=true" style="width:100%; height:900px;" frameborder="0"></iframe>');
  });
  ...
  $("a#methodologyLink").click(function (event) {
    ...
    //Add html.
    $("li#methodologyWidget").html('<div class="handle">Methodology</div><iframe src="http://docs.google.com/gview?url=/irstudies/GSS/PDF/methods.pdf&embedded=true" style="width:100%; height:900px;" frameborder="0"></iframe>');
  });
  ...
  $("a#surveyInstrLink").click(function (event) {
    ...
    //Add html.
    $("li#surveyInstrWidget").html('<div class="handle">Survey Instrument<br /> <a id="surveyInstrumentFullScreenDB" href="#">Daytona Beach</a> | <a id="surveyInstrumentFullScreenPrescott" href="#">Prescott</a></div><iframe id="surveyInstrIFrame" src="http://docs.google.com/gview?url=/irstudies/GSS/PDF/GSS_DB_SP2012.pdf&embedded=true" style="width:100%; height:900px;" frameborder="0"></iframe>');
      ...
      $("a#surveyInstrumentFullScreenDB").click(function (event) {
        ...
        //Add html.
        //$("li#surveyInstrWidget").html('<div class="handle">Survey Instrument<br /> <a id="surveyInstrumentFullScreenDB" href="#">Daytona Beach</a> <a id="surveyInstrumentFullScreenPrescott" href="#">Prescott</a></div><iframe src="http://docs.google.com/gview?url=/irstudies/GSS/PDF/GSS_DB_SP2012.pdf&embedded=true" style="width:100%; height:900px;" frameborder="0"></iframe>');
        //Change iframe src
        $('iframe#surveyInstrIFrame').attr('src', 'http://docs.google.com/gview?url=/irstudies/GSS/PDF/GSS_DB_SP2012.pdf&embedded=true');
      ...
      $("a#surveyInstrumentFullScreenPrescott").click(function (event) {
        ...
        //Change iframe src
        $('iframe#surveyInstrIFrame').attr('src', 'http://docs.google.com/gview?url=/irstudies/GSS/PDF/GSS_PCSurveySP12.pdf&embedded=true');
      });
  ...
  $("a#dataTablesLink").click(function (event) {
    ...
    //Add html.
    $("li#dataTablesWidget").html('<div class="handle">Data Tables</div><iframe src="http://docs.google.com/gview?url=/irstudies/GSS/PDF/Overall%20Tables-ShortVersion.pdf&embedded=true" style="width:100%; height:900px;" frameborder="0"></iframe><div class="widgetsDownload"><a href="/irstudies/GSS/PDF/Overall%20Tables%2011_12.pdf">Download Full Data Tables PDF</a></div>');
  });
