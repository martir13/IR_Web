...
function startTheTour(){
        ...
        introJs().setOptions({doneLabel: "Continue", skipLabel: "Stop"}).start().oncomplete(function() {
          window.location.href = '/Surveys/GSS/Report/UnivExp/overall.html?multipage=true';
        }).onexit(function() {
          window.location.href = '/Surveys/GSS/Report/index.html';
          //history.go(0);
        }).onchange(function(targetElement) {  
          var t=setTimeout(function(){window.scrollTo(0,0);},500)
        });
      }
